        ...
        <div class="columns is-multiline">
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Stydy at your own pace</h2>
          ...
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Stydy with others</h2>
              <p>This is just some random placeholder text</p>
            </div>
          </div>
          <div class="column is-4">
            <div class="box has-text-centered">
              ...
              <h2 class="is-size-4 mt-4 mb-4">Stydy from your home</h2>
              <p>This is just some random placeholder text</p>
            </div>
          </div>
