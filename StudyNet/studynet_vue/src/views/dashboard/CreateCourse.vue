<template>
    <div class="about">
        ...
        <section class="section">
            <div class="mb-6 px-6 py-4 has-background-grey-lighter box">
                ...
                <div class="field">
                    ...
                    <textarea v-model="form.short_description" class="textarea"></textarea>
                </div>
                
                <div class="field">
                    <label>Long description</label>
                    <textarea v-model="form.long_description" class="textarea"></textarea>
                </div>
            ...
            <div class="mb-6 px-6 py-4 has-background-grey-lighter box">
                ...
                >
                    ...
                    <div class="field">
                        <label>Short description</label>
                        <textarea v-model="lesson.short_description" class="textarea" :name="`form.lessons[${index}][short_description]`"></textarea>
                    </div>
                    
                    <div class="field">
                        <label>Long description</label>
                        <textarea v-model="lesson.long_description" class="textarea" :name="`form.lessons[${index}][long_description]`"></textarea>
                    </div>
